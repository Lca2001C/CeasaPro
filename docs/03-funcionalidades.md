...
Rota `/plano`. Mostra o plano atual (nome, preço, situação, vencimento), **todos os módulos** com ✓/✗ (incluído ou não) e o **uso atual** (nº de produtos). Quando o usuário tenta acessar um recurso fora do plano, cai aqui com um aviso e um convite para falar sobre upgrade. Ver [Planos e módulos](05-planos-e-modulos.md).
...
- **Planos** (`/admin/planos`): criar, **editar** e **excluir** planos — preço, ativo e **quais módulos opcionais** o plano inclui. A exclusão é definitiva e só vale para plano que **nenhuma assinatura usa**; se alguma empresa o tiver, a ação é recusada com a contagem e o caminho certo é **desativar** o plano — ele some da oferta e quem já assinou continua como está. Apagar o plano de uma empresa apagaria a prova de quanto e por qual pacote ela paga.
